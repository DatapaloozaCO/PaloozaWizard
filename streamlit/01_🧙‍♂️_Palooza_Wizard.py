...
st.markdown(
    "Palooza Wizard ✨ is a powerful tool that allows users to **create web scrapers with minimal effort**. With **just a URL as input**, this framework generates a Python script 🐍 that enables users to scrape data from a website of their choice 🌐."
)
st.divider()
interacted = 0
